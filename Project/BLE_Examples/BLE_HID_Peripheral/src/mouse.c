...
static void sensorCalibration(int32_t *offset_x, int32_t *offset_y, int32_t *offset_z) {
	...
	for (i = 0; i < 400; i++) {
		...
		pGyrData.AXIS_X = (int32_t) LSM6DSO_FROM_FS_125dps_TO_mdps(data_raw_angular_rate.i16bit[0]) / 1000;
		pGyrData.AXIS_Y = (int32_t) LSM6DSO_FROM_FS_125dps_TO_mdps(data_raw_angular_rate.i16bit[1]) / 1000;
		pGyrData.AXIS_Z = (int32_t) LSM6DSO_FROM_FS_125dps_TO_mdps(data_raw_angular_rate.i16bit[2]) / 1000;
