...
* Version            : 1.3.0
* Date               : 20-July-2020
* Description        : Code demonstrating the BLE OTA Reset Manager application
********************************************************************************
...
* \section Usage Usage
  ...
  - The OTA Reset Manager is a basic application which is  stored at BlueNRG-1,2 FLASH base address (0x10040000) and 
